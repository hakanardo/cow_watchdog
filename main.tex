...
Most previous work on detecting cows using video cameras have focused on monitoring areas where the orientation of the cows was known due to physically limitations imposed by the surroundings. Two examples of this is the Viola-Jones based detector of Arcidiacono et al. \cite{Arcidiacono2012} for detecting cows at the feed barrier and the work of Martinez-Ortiz1 et al. \cite{martinez2013video} to detect and track cow heads in narrow entrance corridors. There are also approaches that rely on more advanced sensors, such as Abdul et. al \citte{abdul2016locomotion} that uses a depth camera.


%http://www.sciencedirect.com/science/article/pii/S1537511015000355
6 cameras to cover 15.4 x 3.8 m area
...
%http://www.shengfenghe.com/uploads/1/5/1/3/15132160/oop_iccv15.pdf
rotated boxes
