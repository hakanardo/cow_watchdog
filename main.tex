...
\address{
  ...
  \add{2}{Swedish University of Agricultural Sciences, Department of Biosystems and Technology,
Växtskyddsvägen 3, Box 103, 23053 Alnarp, Sweden}
...
The pilot study used to develop this watchdog was made in a dairy barn in the south of Sweden with 252
Swedish Holstein cows. Cows were milked by four automatic milking robots, which had a common waiting area
...
for the two different diagonals which mean that producing rotated bounding box from their results would not
...
manufacturer.
The lens distortion was removed, and a homograph was estimated that projected each of the camera images onto
...
In the camera images, the markers placed in the cow shoulder plane was located manually and their distorted
...
by the varying seasons are significant. It was not enought to collect data from three months. Instead both
