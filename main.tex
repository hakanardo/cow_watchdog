...
In order to fulfil the specific research questions regarding dairy barn latted floor and distribution of animals on it,
 a correct transition of image coordinates into real-world coordinates was crucial. To assure that all the coordinates
can be reliable and that the observer/algorithm will be able to correctly dentify all the objects, three images were
merged and synchronised after applying normalisation algorithms. Setups with nly one camera (even with wide
